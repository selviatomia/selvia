...
<body id="page-top">
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome To Aplikasi Mengelola Keuangan Pribadi</h1>
        </div>
    </header>
    <!-- header -->
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                ...
                <p class="isi-fitur text-center"> </p>
            </div>
    ...
    <!-- <footer class="bg-dark foot">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; 2024 Semicolon SQUAD</p>
        </div>
    </footer> -->
